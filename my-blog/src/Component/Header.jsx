      ...
      return (
        <header className="sticky top-0 z-50 bg-white shadow-md transition-all duration-300 ease-in-out">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4 md:justify-between md:space-x-10">
              ...
              <div className="-mr-2 -my-2 md:hidden">
                <button
                  type="button"
                  className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 transition-colors duration-200"
              ...
              <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                {/* Your subscribe button can go here if needed */}
              </div>
            </div>
          </div>
          ...
          <div
            ...
            } md:hidden absolute top-full inset-x-0 p-2 transition transform origin-top-right duration-300 ease-in-out`}
          >
                  ...
                  <nav className="grid gap-y-8">
                    {navItems.map((item) => (
                      <NavLink
                        ...
                        to={item.path}
                        className={({ isActive }) =>
                          `-m-3 p-3 flex items-center rounded-md hover:bg-gray-50 transition-colors duration-200 ${
                            isActive
                              ? "text-indigo-600 hover:text-indigo-500"
