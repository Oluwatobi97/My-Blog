...
function BlogDetail() {
  return (
    <article className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-10">
      ...
      <div className="prose prose-lg mx-auto">
        ...
        <ul className="list-disc pl-6 mt-4 space-y-4">
          <li>
            <strong>Personal Portfolio Website:</strong> I designed and
            developed my own portfolio using React and Tailwind CSS to showcase
            my skills and projects. This project helped me push my creativity
            and showcase my skills to potential clients and employers.
          </li>
          <li>
            <strong>WordPress Blog for a Local Business:</strong> I customized a
            WordPress theme, optimized the site for SEO, and increased the
            client's web traffic by 25%. This project taught me a lot about
            client interaction and delivering high-quality work that meets
            business goals.
          </li>
        </ul>
